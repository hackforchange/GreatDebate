# Django settings for greatdebate project.
import os
import sys
...
DATABASES = {
    'default': {
        ...
        'NAME': 'greadebate.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '_km$bm4((dqwez3y7ziwu!tsjt$%!uiclmwzgg38rbh)=_jna8'
